...
const model = Schema.Model({
  name: StringType().minLength(6, "Minimum 6 characters required").isRequired("This field is required."),
  ...
  verifyPassword: StringType()
    ...
    .isRequired("This field is required."),
  uf: StringType().isRequired("This field is required."),
  city: NumberType().isRequired("This field is required."),
});
